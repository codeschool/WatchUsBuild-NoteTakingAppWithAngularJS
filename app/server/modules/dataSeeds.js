...
module.exports = {
  seed: function() {
    ...
    Category.findOrCreate({"name": "Question", "icon": "question"}).success(function(type){
        ...
        Note.findOrCreate({"UserId": 7, "CategoryId": 6, "link" : "", "description" : "Define Service", "title" : "What is a Service", "content": "Service: Angular services are objects that are wired together using dependency injection (DI). You can use services to organize and share code across your app.", "icon" : "question"});

        {"UserId": 7, "CategoryId": 6, "description" : "Steps for Creating a Service", "title" : "How do you create a Service?", "content": "You can register a service to our Angular module `app` with a one of the following 5 recipes: \\n 	- **factory**  \\n 	- **provider**  \\n 	- **service**  \\n 	- **value**  \\n 	- **constant** ", "icon" : "question"});
